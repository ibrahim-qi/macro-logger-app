    ...
    `}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-stone-500 mt-1">Weekly Summary</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-stone-100 p-6">
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-stone-500">Loading weekly data...</p>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-stone-700 mb-2">No data for this week</h3>
            <p className="text-sm text-stone-500">Start logging your meals to see your weekly summary</p>
          </div>
        ) : (
          <div>
