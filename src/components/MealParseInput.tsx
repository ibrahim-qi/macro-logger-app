...
const MealParseInput = forwardRef<MealParseInputHandle, MealParseInputProps>(({
  ...
  const orbStyle = { '--voice-level': audioLevel } as CSSProperties;
  ...
  return (
    <div className="log-voice-input">
      <div className={`sahha-voice sahha-voice--log ${isRecording ? 'sahha-voice--live' : ''} ${isProcessing ? 'sahha-voice--busy' : ''}`}>
